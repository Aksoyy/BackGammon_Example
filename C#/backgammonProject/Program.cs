...
namespace ConsoleApp5
{
    class Program
    {
        ...
        private static int hesapla(int ilkkonum, int konum, Dictionary<int, int> hesapListesi)
        {
            ...
            else if (ilkKonumTasSayisi >= 2 && SonKonumTasSayisi == 1) //Bir taş açığa çıkarmak -1 puan
            {
                puan--;
            }
            ...
            else if (SonKonumTasSayisi == 2) //Bir kapı kapatmak +1 puan, eğer önemli kapı ise ise +2
            {
                puan = puan + 1;
